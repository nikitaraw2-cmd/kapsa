...
const colorProducts: Product[] = [
  {
    id: "color-1",
    title: "Книги в синей гамме (12 шт)",
    description: "От светло-голубых до тёмно-синих оттенков. Создают спокойную атмосферу.",
    price: "4 490 ₽",
  ...
  {
    id: "color-2",
    title: "Тёплые оттенки: красный и оранжевый (15 шт)",
    description: "Яркие акценты для энергичных интерьеров. Красные, оранжевые, терракотовые.",
    price: "5 490 ₽",
  ...
  {
    id: "color-3",
    title: "Зелёная коллекция (10 шт)",
    description: "Природные оттенки зелёного. От мятного до изумрудного.",
    price: "4 490 ₽",
  ...
  {
    id: "color-4",
    title: "Радужный набор (20 шт)",
    description: "Все цвета радуги. Для создания градиента на полке.",
    price: "7 990 ₽",
  ...
  {
    id: "color-5",
    title: "Пастельная палитра (18 шт)",
    description: "Нежные пастельные тона: розовый, мятный, лавандовый, персиковый.",
    price: "6 490 ₽",
  ...
  {
    id: "color-6",
    title: "Монохром: чёрно-белый (15 шт)",
    description: "Контрастное сочетание чёрного и белого для строгих интерьеров.",
    price: "5 990 ₽",
      ...
      <div style={{
        ...
        >
          ...
          <p style={{
            ...
            Подбираем книги под цветовую гамму вашего интерьера. От монохрома до радужных сочетаний.
          </p>
        </motion.div>
        ...
        <div style={{
          ...
          {['Любой цвет', 'Градиенты', 'Монохром', 'Быстрая доставка'].map((feature, index) => (
            <motion.div
              key={feature}
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      >
        <div style={{
          ...
          <p style={{
            ...
            Мы подберём книги в любой цветовой гамме специально под ваш интерьер
          </p>
          <motion.button
